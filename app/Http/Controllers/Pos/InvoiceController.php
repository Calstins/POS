...
class InvoiceController extends Controller
{
    ...
    public function InvoiceStore(Request $request){
        ...
        if ($request->category_id == null) {
           ...
           $notification = array(
            'message' => 'Sorry you have not selected any item',
            'alert-type' => 'error'
        );
        return redirect()->back()->with($notification);
            ...
            if ($request->paid_amount > $request->estimated_amount) {
               ...
               $notification = array(
                    'message' => 'Sorry the part-payment is more the total price, ',
                    'alert-type' => 'error'
                );
                return redirect()->back()->with($notification);
    ...
    public function PendingList(){
        ...
        return view('backend.invoice.invoice_pendinglist',compact('allData'));
    } // End Method
    ...
    public function ApprovalStore(Request $request, $id){
        ...
        foreach($request->selling_qty as $key => $val){
            ...
            if($product->quantity < $request->selling_qty[$key]){
                ...
                $notification = array(
                'message' => 'Sorry the quantity approved is more than the stock available',
                'alert-type' => 'error'
                );
